...
#%% plot the losses of the finetuned MLP7 WITHOUT feature_extraction (setting0)
visualizations.losses("mlp", 7, "", simulations = None, finetuned = True, setting = 0)
#%% plot the losses of the finetuned MLP7 WITH feature_extraction (setting0)
visualizations.losses("mlp", 7, "", simulations = None, finetuned = True, setting = 1)
