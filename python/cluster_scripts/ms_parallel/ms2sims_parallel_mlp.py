...
# Use only first 20 percent of data  (10000 Datapoints)
ind = int(np.floor(X.shape[0]/100*20))
X, Y = X[:ind], Y[:ind]
...
if __name__ == '__main__':
    ...
    results.to_csv(r"/home/fr/fr_fr/fr_mw263/output/grid_search/simulations/grid_search_results_mlp2_np.csv", index = False)